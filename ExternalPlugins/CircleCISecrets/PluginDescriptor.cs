    ...
    public class PluginDescriptor : ILoadablePlugin
    {
        ...
        public void SetVaultCredential(string credential)
        {
            if (_configuration != null && credential != null)
            {
                try
                {
                    _secretsClient = new VaultConnection(_configuration[AddressName], credential, _logger);
        ...
        public bool TestVaultConnection()
        {
            ...
            try
            {
                var response = _secretsClient.InvokeMethodFull(Method.GET, $"v1/{_configuration[MountPointName]}/config");
        ...
        {
            if (_configuration == null || _secretsClient == null)
            {
            ...
            try
            {
                ...
                var response = _secretsClient.InvokeMethodFull(Method.POST, $"v1/{_configuration[MountPointName]}/data/{name}", payload);
